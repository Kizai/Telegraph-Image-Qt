...
logging.basicConfig(filename='image_uploader.log', level=logging.INFO,
...
class ImageUploader(QWidget):
    def __init__(self):
        ...
        self.tray_icon.setIcon(QIcon("icon/logo.ico"))
        ...
        try:
            ...
            logger.error("Error initializing ImageUploader: %s", e)
    ...
    def select_image(self):
        ...
        if image_path:
            ...
            max_file_size = 5 * 1024 * 1024  # for a 5MB limit

            if file_size > max_file_size:
                QMessageBox.warning(self, 'File Too Large',
                                    'The selected file is too large. Please select a <= 5MB file.')
                return
    ...
    def set_api_url(self):
        try:
            ...
            logger.error("Error setting API URL: %s", e)
    ...
    def upload_gif(self):
        try:
            ...
            self.link_area.setPlainText(f'Error: {str(e)}')
            logger.error("Error uploading GIF: %s", e)
